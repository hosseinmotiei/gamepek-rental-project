...
@section('title', 'نشان اعتماد جدید')
@section('page_badge', 'نشان جدید')
@section('breadcrumb')
...
<div class="max-w-2xl">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
        <h1 class="text-xl font-black text-gray-800 mb-6">نشان اعتماد جدید</h1>

        <form method="POST" action="{{ route('admin.trust-badges.store') }}" enctype="multipart/form-data" class="space-y-5"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="icon" value="{{ old('icon') }}" placeholder="fa-solid fa-shield-check" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-brandBlue" dir="ltr">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">کلاس رنگ آیکون</label>
                    <input type="text" name="color_class" value="{{ old('color_class', 'text-blue-400') }}" placeholder="text-blue-400" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-brandBlue" dir="ltr">
                </div>
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">تصویر (اختیاری)</label>
